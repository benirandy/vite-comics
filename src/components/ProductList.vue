<template>
    <div class="products">
        ...
        <div v-for="(hero, index) in herotype" class="box" :key="index">
            <HerotypeCard :image="hero.thumb" :title="hero.series" />
        </div>
...
<script>
import HerotypeCard from './HerotypeCard.vue';
    ...
    data() {
        return {
            herotype: [
                ...
                {
                    thumb: "https://static.dc.com/2023-03/DCConnect_35-CVR.jpg?w=640",
                    price: "$5.99",
                ...
                {
                    thumb: "https://static.dc.com/2023-03/LP-ROTG_Cv1_00111_DIGITAL.jpg?w=640",
                    price: "$4.99",
